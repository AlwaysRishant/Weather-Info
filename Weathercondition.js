...
export default function Weather({ cityname }) {
  ...
  return (<>
    {loading && <div className="text-bg-danger fs-5 text-center">Loading. Please wait. . .</div>}
    ...
    <div>
      ...
      <div class="col">
        <div class="card mb-4 rounded-3 shadow-sm">
          ...
          <div class="card-body">
            <h1 class="card-title pricing-card-title"><small class="text-body-secondary fw-light">{weather.max_temp} °C</small></h1>
      ...
      <div class="col">
        <div class="card mb-4 rounded-3 shadow-sm">
          ...
          <div class="card-body">
            <h1 class="card-title pricing-card-title"><small class="text-body-secondary fw-light">{weather.humidity} %</small></h1>
            <ul class="list-unstyled mt-3 mb-4">
      ...
      <div class="col">
        <div class="card mb-4 rounded-3 shadow-sm border-primary">
          ...
          <div class="card-body">
            <h1 class="card-title pricing-card-title"><small class="text-body-secondary fw-light">{weather.wind_speed} Km/Hr</small></h1>
            <ul class="list-unstyled mt-3 mb-4">
  ...
  <caption className="text-center fs-1 fw-semibold text-dark">Past searches resullt</caption>
  <thead>
    <tr>
